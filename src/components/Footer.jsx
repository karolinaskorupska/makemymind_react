    ...
    <footer>
      <div className="footer">
        <div className="left">
          ...
          <div className="tel">
            <img src="assets/np_phone_2828705_9B9B9B.svg" alt="phoneIcon"></img>
            +48 000 000 000
          </div>
          <div className="mail">
            <img src="assets/np_mail_933334_9B9B9B.svg" alt="EmailIcon"></img>
          ...
          <div className="icons">
            ...
            <Link to="https://www.instagram.com/make_my_mind/" target="_blank">
              <img src="assets/Instagram_Icon.svg" alt="Instagram"></img>
            </Link>
          </div>
        </div>
        <div className="middle">
          Make my mind sp. z o. o. <br></br> KRS: 0000677255, NIP:7451847771,{" "}
          <br></br> REGON: 366168664 <br></br> ul. Fredry 2/5a <br></br> 61-701
          Poznań, Polska
        </div>
        <div className="right">
          Fitness dla umysłu
